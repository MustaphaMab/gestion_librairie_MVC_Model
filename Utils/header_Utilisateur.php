      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="?controller=livres&action=all_livres_par_titre">Par titre</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="?controller=fournisseurs&action=fournisseurs_par_localite">Par localité</a></li>
            <li><a class="dropdown-item" href="?controller=fournisseurs&action=fournisseurs_par_pays">Par pays</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="?controller=commandes&action=commandes_par_editeur">Par éditeur</a></li>
            <li><a class="dropdown-item" href="?controller=commandes&action=commandes_par_fournisseur">Par fournisseur</a></li>
            <li><a class="dropdown-item" href="?controller=commandes&action=commandes_par_date">Par date</a></li>
          </ul>
